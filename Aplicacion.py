...
if Temas == 'Introducción':
    ...
    st.latex('El efecto fotoel[ectrico nos dice que si un electrón absorve la energía de un fotón y este tiene más energía que la función del trabajo el electrón es arrancado del material')
